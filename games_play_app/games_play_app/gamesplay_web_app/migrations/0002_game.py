...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gamesplay_web_app', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('ACTION', 'Action'), ('ADVENTURE', 'Advenure'), ('PUZZLE', 'Puzzle'), ('STRATEGY', 'Strategy'), ('SPORTS', 'Sports'), ('BOARD_CARD', 'Board/Card Game'), ('OTHER', 'Other')], max_length=15)),
